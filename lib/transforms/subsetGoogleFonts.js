...
function asyncLoadStyleRelationWithFallback(htmlAsset, originalRelation) {
    ...
    prefetchRelation.attach(htmlAsset, 'before', injectionPointRelation);
    ...
    preconnectRelation.attach(htmlAsset, 'before', injectionPointRelation);
...
module.exports = function (options) {
    ...
    var fontDisplay = validFontDisplayValues.includes(options.fontDisplay) && options.fontDisplay;
        ...
        assetGraph
            ...
            .queue(function moveSubsetAssetsToLocal(assetGraph) {
                Object.keys(htmlAssetTextByPropsMap).forEach(function (assetUrl) {
                        ...
                        if (qs.family) {
                            ...
                            fontStyleSheetRelation.to.outgoingRelations.forEach(function (fontRelation) {
                                ...
                                if (inlineSubsets) {
                                    ...
                                    var htmlAsset = fontStyleSheetRelation.from;
                                    ...
                                    preloadRelation.attach(htmlAsset, 'before', fontStyleSheetRelations[0]);
                                }
                            });
                        }
                    });
                    ...
                    var fontStyleBundle = assetGraph.findAssets({ type: 'Css', isLoaded: true, url: /google-font-subsets\/fonts-/, text: source })[0];
                    ...
                    bundleRelation.attach(htmlAsset, 'before', fontStyleSheetRelations[0]);
